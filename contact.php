...
<head>
    ...
    <title>FG - Contact opnemen</title>
    ...
    <div class="jumbotron jumbotron-contact">
        <div class="jumbotron-header">
            <form method="post">
                ...
                <div class="form-group"><input class="form-control" id="form-name" type="text" name="name" placeholder="Naam"></div><small class="form-text text-danger" id="name-error-message"> <br></small>
                <div class="form-group"><input class="form-control" id="form-email" type="text" name="name" placeholder="Email"></div><small class="form-text text-danger" id="email-error-message"> <br> </small>
                <div class="form-group"><textarea class="form-control" id="form-message" name="message" placeholder="Bericht" rows="14"></textarea></div><small class="form-text text-danger" id="msg-error-message"> <br> </small>
                <div class="form-group"><button class="btn btn-primary card-button" id="sendButton-contact" onclick="processMessage()" type="button">Verstuur</button></div>
            </form>
        </div>
    </div>
    <script>
